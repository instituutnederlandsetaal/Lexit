			...
			"button_0":{
				...
				"click": function(t){
					...
					var wordform = fn.prompt("Geef een host, een database, en een tabelnaam", 
						...
						var sHost = fn.getPromptUserInput("host");
						var sDatabaseName = fn.getPromptUserInput("database_name");
						var sTableName = fn.getPromptUserInput("table_name");
			...
			"host": {
				...
				"editcallback": function(t, n, value){
					fn.updateDatabaseGivenANode(t, fn.getRowNode(n), 
							["descr_date"], 
							[fn.getCurrentTimestamp("YYYY-MM-DD HH:MI:SS")], 
							false, 
							function(){
						fn.refreshTable(t);
					});
