						...
						if ( fn.getNumberOfSelectedRows(confTable)>0)
							...
							aSelectedRows.each(function(){
								...
								fn.removeFromDatabaseGivenFieldValues("GB05_2013", 
										{"id": sId}, 
										function(){
											if (bIsLastRow) fn.refreshTable("GB05_2013");
										});
								});
							}
						else
...
function editAndLog(oTable, nNode, sValue){
	...
	fn.updateDatabaseGivenANode(nNode, 
		{
		"wijzignaam15": fn.getCurrentUser(), 
		"wijzigdatum15": fn.getCurrentTimestamp("YYYY-MM-DD HH:MI:SS")
		});
}
