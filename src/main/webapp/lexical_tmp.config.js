			...
			"button_0":
				...
				"click": function(confTable){
					var sLemmaAndPos = fn.prompt("Voeg waardes in", 
						...
						var wrdcat = fn.getPromptBoxInput("wrdcat");
						var znwlid = fn.getPromptBoxInput("znwlid");
						var comment = fn.getPromptBoxInput("comment");
						var gigant_tag = fn.getPromptBoxInput("gigant_tag");
				...
				"click": function(confTable){
					...
					if (answer)
						...
						nNode.each(function(){
							...
							fn.removeFromDatabaseGivenANode(this);
							});
...
//				"click": function(t, n){					
//					var lemma = "^"+fn.getDataFromSiblingNode(n, "lemma")+"$";
//					
...
//		},
		...
		werktabel:{
			"copy": {
				...
				"click": function(t, n){
					var value = fn.getDataFromSiblingNode(n, "gigant_tag");
					fn.updateDatabaseGivenANode(n, {"gigant_tag_correctie": value}, function(){
						fn.refreshTable(t);
					});
				}
			},
