...
var sApplicationName = "banko di papiamentu"; // beware: without capital is the right name
...
var sCobaltMenuItemColor = "#ffffff";
...
var sCobaltEvenRowSelected = "#8888CC" // "#CCE7FF"; // dit is NIET duidelijk, maak donkerder?
var sCobaltOddRowSelected =  "#8888CC" // "#CCE7FF";
...
fn.addCss(".ui-menu-item {font-weight: bold !important; background-color: "+sCobaltMenuItemColor+" !important;}"); //  dit bepaalt ook de kleur van de autocomplete lists, dus gewoon wit....
fn.addCss(".ui-menu-item div.ui-state-active {font-weight: bold !important; background-color: "+sCobaltMenuItemColor+" !important;}");

//fn.addCss(".ui-autocomplete {background-color: pink !important}");
...
var setLogo = true
var logo = "../lexit2_config/papiamentu/logo.png"
