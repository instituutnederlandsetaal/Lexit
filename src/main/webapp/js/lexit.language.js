...
lang.searching_records = "Zoeken in de database...";
...
// table import
lang.import_tablelist_uploadlabel = "Uploadbestanden";
lang.import_dialog_title = "Bestand uploaden";
lang.import_dialog_msg = "Kies een CSV- of XL-bestand om te uploaden";
lang.import_uploadbutton = "Uploaden";
lang.import_erase_tooltip = "Verwijder deze geüploade tabel";
lang.import_erase_confirm = "Weet u zeker dat u deze tabel wilt verwijderen?<BR><BR>(Dit kan niet ongedaan worden gemaakt)";
lang.import_erase_table_failed = "Het verwijderen van de tabel is mislukt";
lang.import_erase_table_done = "De table is verwijderd";
...
lang.admingui_add_multipleroles_success = "De gebruikersrollen zijn opgeslagen:";
...
lang.error = "Fout";
lang.forgot_compulsory_field = "U bent vergeten het veld 'FIELDNAME' in te vullen";
...
lang.columns_list_mismatch = "De lijst kolommen in \"columns_order\" (in de configuratie) komt niet overeen met de werkelijke kolommen.<BR><BR>";
...
lang.columns_list_to_compare = "Te vergelijken kolommen"; 
...
lang.formlist_add_row = "Voeg rij toe";
...
lang.setLanguage = function(sLanguageCode){
	...
	if (sLanguageCode != "nl"){
		...
		lang.helpText = 
				...
				"<TD></TD>" +
				"<TD>" +
				"This function enables you to move to a place in the table with one click. This function is different from the normal search function, because nothing gets filtered away: it is not a filtering function but a navigation function.<BR><BR>" +
	...
	if (sLanguageCode == "nl"){
		...
		lang.searching_records = "Searching the database...";
		...
		// table import
		lang.import_tablelist_uploadlabel = "Updloaded files";
		lang.import_dialog_title = "Upload a file";
		lang.import_dialog_msg = "Choose a CSV or XL file to upload";
		lang.import_uploadbutton = "Upload";
		lang.import_erase_tooltip = "Remove this uploaded table";
		lang.import_erase_confirm = "Are you sure you want to remove this table?<BR><BR>(This can't be undone)";
		lang.import_erase_table_failed = "Error: couldn't remove the uploaded table.";
		lang.import_erase_table_done = "The table has been removed.";
		...
		lang.admingui_add_multipleusers_title = "Create multiple users at once";
		...
		lang.admingui_add_multipleusers_success = "The users are added:";
		...
		lang.admingui_add_multipleroles_success = "The users roles are set:";
		lang.admingui_add_multipleroles_error = "Adding/Updating multiple users roles went wrong:";
		...
		lang.forgot_compulsory_field = "You've forgot to fill in the 'FIELDNAME' field";
		lang.error = "Error";
		...
		lang.columns_list_mismatch = "The columns list in \"columns_order\" (in the config file) doesn't match the true list of columns.<BR><BR>";
		...
		lang.columns_list_to_compare = "Column names to compare";
		...
		lang.formlist_add_row = "Add a row";
