...
ssr.buildSearchAndReplaceDiv = function(sSomeTablename){
	...
	var div = $("<div></div>")
		.addClass("simple_search_and_replace")
	...
	var titleAndButtonDiv = $("<div></div>").addClass("ssr_title_wrapper");
	var titleDiv = $("<div></div>").addClass("ssr_title_div");
	var buttonDiv = $("<div></div>").addClass("ssr_button_div");
	
	titleDiv.append(
		$("<span></span>").addClass("ssr_title").text(lang.header_search_and_replace_button+ " ")
	);
	titleDiv.append(
		$("<span></span>").text(lang.header_search_and_replace_safemode)
	);
	buttonDiv.append( ssr.buildSelectionButton(sSomeTablename) );
	
	titleAndButtonDiv.append(titleDiv);
	titleAndButtonDiv.append(buttonDiv);
	...
	var column_to_alter = $("<div></div>").attr("id", sSomeTablename+"_column_to_alter");	
	...
	var action_to_perform = $("<div></div>").attr("id", sSomeTablename+"_action_to_perform");
	...
	var old_and_new_value = $("<div></div>").addClass("ssr_old_and_new_value");
	...
	// buttons
	var buttons_span = $("<div></div>").addClass("ssr_buttons_span");
