...
var oTableSettingsList_example = {
		...
		/**
		 * @type {object}
		 * @description Declareer een formulier, als custom weergave van een tabel (dit wordt in de handleiding uitgebreid uitgelegd).
		...
		/**
		 * @type {string}
		 * @description Om in het tabeloverzicht meer info over een tabel te geven, legt men deze info hier vast.
		...
		/** 
		 * @type {object} 
		 * @description voeg een volledig export button aan de tabel voeter toe (zie handleiding voor meer info)
		 */
		"full_export_button": {},
...
var oTableConfigurationList_example = {
		 ...
		 * 
		 * Lex'it heeft enige default classes beschikbaar, zoals 'inlfont10pt' (voor weergave van INL font in 10 pt),
		 * of 'inlfont' (deze zonder font-size specificatie). 
		 */
		"class": "",
		...
		/**
		 * @type {boolean}
		 * @description Als dit 'false' is, wordt de query builder by CTRL+klik in het zoekveld uitgeschakeld.
		 */
		"query_builder_allowed": false,
		
		/**
		 * @type {object}
		 * @description declareer de in de query builder te tonen zoekwaarden (keys) en hun vertaling in voor de database begrijpelijke waarden om een welgevormde query samen te stellen (values).
		...
		/**
		 * @type {function}
		 * @description functie om de door query builder geformuleerde query aan te passen voordat deze wordt afgevuurd op de database.
		 */		
		"query_builder_processor": function(query){}, 
		
		/**
		 * @type {object}
		 * @description settings voor de query builder (indien default gedrag aangepast moet worden).
		 * Parameter 'grid': true/false bepaalt of de zoekwaarden al dan niet als een grid getoond moeten worden.
		 * Parameter 'preselected' bepaalt welke waarde in de query builder alvast geselecteerd moet zijn.
		 * Parameter 'autostart': true/false bepaalt of de door de query builder geformuleerde query bij klikken op OK al dan niet direct moet worden afgevuurd op de database.
		 */
