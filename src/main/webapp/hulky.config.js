		...
		hulk_comparison:{
			...
			modern_lemma:{
				...
				"click": function(t, n){					
					...
					var lem = fn.getDataFromCellNode(t, n);
			...
			oudste_hulk: {
				...
				"click": function(t, n){
					var oordeel = fn.getDataFromCellNode(t, n);
					var lem = fn.getDataFromSiblingNode(t, n, "modern_lemma");
					var tabel;
					if (oordeel == 'OK')
						tabel = "valid_words";
					else if (oordeel == 'NOK')
