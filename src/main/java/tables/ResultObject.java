...
/**
 * The ResultObject holds the results of a request to the 'gettable' endpoint of the webservice.
 * 
 * That is: a list of rows, the total number of rows in the table, the number of retrieved rows, etc.
 */
