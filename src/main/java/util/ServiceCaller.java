...
public class ServiceCaller {
	...
	public String call(String requestMethod, String urlParameters, String charEncoding, String contentType) {
		...
		// will be considered a GET request
			...
			try (BufferedReader rd = new BufferedReader(new InputStreamReader(oracle.openStream(), charEncoding))) {
