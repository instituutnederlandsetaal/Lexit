				...
				"click": function(t){
					...
					fn.confirm("Let op", "Weet u het zeker?", function(){
						...
						oRows.every(function(){
							...
							fx.removeFromDatabaseGivenARow(oCurrentRow, bLastRow);	
							});
					});
				...
				"click": function(t){
					...
					fn.confirm("Verwijder selectie", "Weet u het zeker?", function(){
						...
						oRows.every(function(){
							...
							fx.removeFromDatabaseGivenARow(this, false, function(){
								if (bLastRow) 
									fn.refreshTable(t);
							});							
				...
				"editcallback": function(t, nRow, value){
					...
					fn.getRecordGivenFieldValues("pos_to_rang", {"pos": fn.escapeRegexChars(value)}, 
							function(record){
								...
								fx.updateDatabaseGivenACellOrRow(oRow, ["rank"], [iRankvalue], false, function(){
...
//				"visible": false
			...
			"gedrukt": {
				...
				"editcallback": function(t, n, value){
					...
					if (value == true)
						{				
						fn.updateDatabaseGivenANode(fn.getRowNode(n), ["online"], [value], true);
						}
				}
			},
			"verkleinwoord": {
				...
				"click": function( t, n ){
					...
					fn.updateDatabaseGivenFieldValues("paradigma_view", 
							...
							function(){
								...
								fn.removeFromDatabaseGivenANode(n, true);
								fn.callDatabase("paradigma_view", 
										{"lemma_id": sLemmaId},
										function(){
