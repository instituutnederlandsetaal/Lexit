...
```sh
DOCKER_VERSION= # docker tag: "dev" or a version from https://github.com/INL/Lexit/releases
CONFIGS_VERSION= # github ref: "origin/development" or a version from https://github.com/INL/Lexit-configs/releases
...
# projects retrieved from https://github.com/INL/Lexit-configs by default.
PROJECTS_GIT=https://github.com/INL/Lexit-configs
